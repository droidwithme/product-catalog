package com.revest.demo.shared.presentation.core
...
public fun <T> List<T>.toViewState(): ViewState<List<T>> = when {
    this.isEmpty() -> ViewState.Loading
    else -> ViewState.Success(data = this)
}
